...
class EditProfilNotifier with ChangeNotifier {
  ...
  Future<void> update(String name, String email, String password,
      String passwordConfirm, String token, File img) async {
    _status = FetchStatus.LOADING;
    try {
      var response = await network.updateProfile(
          token, name, email, password, passwordConfirm, img);
      data = response.data;
    } catch (e) {
