...
class RegisterNotifier with ChangeNotifier {
  ...
  Future<void> fetch(String name, String username, String email, String password, String password_conf) async {
    _status = FetchStatus.LOADING;
    notifyListeners();
    try{
      var response = await network.register(name, username, email, password, password_conf);
      data = response.data;
